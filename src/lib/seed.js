...
export const SCHEDULE = [
  {
    ...
    items: [
      ...
      { start: "21:00", end: "23:00", title: "فقرات متنوعة للفرق", desc: "بودكاست · اللغز · المسابقة — بالتبديل بين القاعات: ٩:٠٠–٩:٣٠ (البسين: كات هيت · مارمينا: طانخو · أبو سيفين: شيش)، ٩:٣٠–١٠:٠٠ (البسين: شيش · مارمينا: كات هيت · أبو سيفين: طانخو)، ١٠:٠٠–١٠:٣٠ (البسين: طانخو · مارمينا: شيش · أبو سيفين: كات هيت)", icon: "🎤" },
